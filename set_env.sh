...
export DASHBOARD_PASSWORD=123456export 
export POSTGRES_HOST=db
export POSTGRES_DB=postgres
export POSTGRES_PORT=5433 #5432export 
export KONG_HTTP_PORT=8001 #8000
export KONG_HTTPS_PORT=8444 #8443export 
export PGRST_DB_SCHEMAS=public,storage,graphql_publicexport 
export SITE_URL=http://localhost:3001
export ADDITIONAL_REDIRECT_URLS=
export JWT_EXPIRY=3600
export DISABLE_SIGNUP=false
export API_EXTERNAL_URL=http://localhost:8001export 
...
export MAILER_URLPATHS_EMAIL_CHANGE="/auth/v1/verify"export 
...
export SMTP_SENDER_NAME=fake_senderexport 
export ENABLE_ANONYMOUS_USERS=false
export ENABLE_PHONE_SIGNUP=false
export ENABLE_PHONE_AUTOCONFIRM=trueexport 
export STUDIO_DEFAULT_ORGANIZATION=My-Org
export STUDIO_DEFAULT_PROJECT=My-Project
export STUDIO_PORT=3001 #3000
export SUPABASE_PUBLIC_URL=http://localhost:8001 #8000export 
export FUNCTIONS_VERIFY_JWT=falseexport 
...
export GOOGLE_PROJECT_NUMBER=Noneexport 
